      ...
      <section className="card artsizer-app">
        ...
        <div className="artsizer-layout">
          <aside className="artsizer-drawer" aria-label="Standard frame sizes">
            ...
            <div className="artsizer-actions"><button type="button" onClick={() => setSnapEnabled((current) => !current)}>{snapEnabled ? 'Turn snapping off' : 'Turn snapping on'}</button><button type="button" onClick={resetLayout}>Reset</button></div>{selectedPiece && <p className="artsizer-selection">Selected: <strong>{selectedPiece.label}</strong>. Use the frame icons to resize, rotate, or delete.</p>}
